...
public class VideoStoreTest {
    ...
    public void setUp() {
        ...
        newReleaseMovie1 = new ReleaseMovie("New Release 1", Movie.NEW_RELEASE);
        newReleaseMovie2 = new ReleaseMovie("New Release 2", Movie.NEW_RELEASE);
        childrensMovie = new ChildreanMovie("Childrens", Movie.CHILDRENS);
